...
namespace Dusk
{
  ...
  const unsigned int ITEM_BIT = 2;
  const unsigned int OBJECT_BIT = 4;
  const unsigned int OBJECT_REF_BIT = 8;

  const unsigned int ALL_BITS = LANDSCAPE_BIT | ITEM_BIT | OBJECT_BIT | OBJECT_REF_BIT;
