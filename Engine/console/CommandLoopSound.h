  ...
  class CommandLoopSound : public Command
  {
    public:
      /* constructor
         ...
         parameters:
             SourceID - ID of Source whose loop mode shall be changed
             DoLoop   - indicates whether source shall be put into loop
                        mode (true) or not (false)
      */
      CommandLoopSound(const std::string& SourceID, const bool DoLoop);
      /* destructor */
