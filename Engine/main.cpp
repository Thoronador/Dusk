/*
 -----------------------------------------------------------------------------
    ...
    Copyright (C) 2007, 2008, 2009, 2010, 2012, 2013 ssj5000, DaSteph, walljumper, thoronador
...
int main(int argc, char **argv)
{
    ...
    catch(Dusk::IDNotFound& e)
    {
      ...
      MessageBox(NULL, e.what(), "A Dusk-specific exception has occured!", MB_OK | MB_ICONERROR | MB_TASKMODAL);
      #else
